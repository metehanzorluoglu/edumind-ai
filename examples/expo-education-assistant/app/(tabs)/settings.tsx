...
export default function SettingsScreen() {
  ...
  async function handleExportData(): Promise<void> {
    ...
    try {
      ...
      await saveJsonExport('edum8-data-export.json', {
  ...
  const serviceProblem =
    readiness !== null && (!readiness.backend || !readiness.ollama || !readiness.qdrant)
      ? !readiness.backend
        ...
        : 'Some EduM8 features may be slower or briefly unavailable while we restore full service.'
      : null;
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ConfirmDialog
        ...
        title="Delete your EduM8 data?"
        body="This permanently deletes all of your conversations and uploaded documents, then signs you out. Your EduM8 account itself is not deleted — you can sign in again later. This cannot be undone."
      ...
      <InfoDialog
        ...
        body="EduM8 stores the documents you upload and the conversations you start so it can answer questions grounded in your material. Your documents are chunked and indexed for retrieval only — they are never used to train models and are never shared with other users. You can export a copy of your data or delete it entirely from this screen at any time."
